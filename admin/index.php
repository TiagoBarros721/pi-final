        ...
        ***********************************-->
		...
		<ul class="metismenu" id="menu">
            ...
            include_once("includes/config.inc.php");
                $path = $arrConfig["url_site"]."crud.php";
		        echo "<button onclick=\"window.open('$path')\">Abrir CRUD</button>";
            ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Utilizadores 🧍</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white"><?php
                                    
                                    $size = my_query("SELECT COUNT(*) FROM login");
                                    $size = $size[0]["COUNT(*)"];
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-4">
                            <div class="card-body">
                                <h3 class="card-title text-white">Satisfação 💯</h3>
                                <div class="d-inline-block">
